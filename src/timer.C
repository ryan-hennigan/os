...
void Timer::handle_interrupt(REGS *_r) {
...
void Timer::set_frequency(int _hz) {
...
void Timer::current(unsigned long * _seconds, int * _ticks) {
...
void Timer::wait(unsigned long _seconds) {
